...
public static class UIExtensions 
{
    ...
    /// <summary>
    /// Scroll the target element to the center of the scroll rect's viewport.
    ...
    public static void ScrollToCenter(this ScrollRect scrollRect, GameObject caller, RectTransform target, RectTransform.Axis axis = RectTransform.Axis.Vertical)
    {
        ...
        float animated_scroll_end_pos;
        float animated_scroll_start_pos;
        ...
        if (axis == RectTransform.Axis.Vertical)
        {
            ...
            animated_scroll_end_pos = Mathf.Clamp(scrollPos, 0, 1);
            animated_scroll_start_pos = scrollRect.horizontalNormalizedPosition;
            LeanTween.value(animated_scroll_start_pos, animated_scroll_end_pos, 0.25f).setOnUpdate((float value) =>
            {
